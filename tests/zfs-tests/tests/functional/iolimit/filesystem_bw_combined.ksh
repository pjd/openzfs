...
log_must ioiolimit_bw_read 12 3 "$TESTDIR/file"
log_must ioiolimit_bw_write 15 3 "$TESTDIR/file"
stopwatch_start
...
log_must ioiolimit_bw_read 12 3 "$TESTDIR/lvl0/lvl1/lvl2/file0"
log_must ioiolimit_bw_write 15 3 "$TESTDIR/lvl0/lvl1/lvl2/file1"
stopwatch_start
