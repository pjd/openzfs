...
log_must ioiolimit_bw_read 12 3 "/dev/zvol/$TESTPOOL/$TESTFS/vol0"
log_must ioiolimit_bw_write 15 3 "/dev/zvol/$TESTPOOL/$TESTFS/vol1"
stopwatch_start
...
log_must ioiolimit_bw_read 12 3 "/dev/zvol/$TESTPOOL/$TESTFS/lvl0/lvl1/lvl2/vol0"
log_must ioiolimit_bw_write 15 3 "/dev/zvol/$TESTPOOL/$TESTFS/lvl0/lvl1/lvl2/vol1"
stopwatch_start
