...
log_must ioiolimit_bw_read 6 6 "$TESTDIR/foo/file"
log_must ioiolimit_bw_read 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_read 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_read 6 6 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
...
log_must zfs set iolimit_bw_read=1M "$TESTPOOL/$TESTFS/baz"
log_must ioiolimit_bw_read 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_read 6 9 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_read 6 12 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
...
log_must ioiolimit_bw_read 6 3 "$TESTDIR/foo/file"
log_must ioiolimit_bw_read 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_read 6 9 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_read 6 12 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
...
log_must ioiolimit_bw_write 6 6 "$TESTDIR/foo/file"
log_must ioiolimit_bw_write 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_write 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_write 6 6 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
...
log_must zfs set iolimit_bw_write=1M "$TESTPOOL/$TESTFS/baz"
log_must ioiolimit_bw_write 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_write 6 9 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_write 6 12 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
...
log_must ioiolimit_bw_write 6 3 "$TESTDIR/foo/file"
log_must ioiolimit_bw_write 6 6 "$TESTDIR/foo/file" "$TESTDIR/bar/file"
log_must ioiolimit_bw_write 6 9 "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
log_must ioiolimit_bw_write 6 12 "$TESTDIR/file" "$TESTDIR/foo/file" "$TESTDIR/bar/file" "$TESTDIR/baz/file"
